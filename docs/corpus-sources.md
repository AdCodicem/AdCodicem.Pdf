...
| W11 | US Topo map, Washington West, 2023 | 63.1 MB, too large to commit | One page with a 109.5-megapixel image. The false truncated-stream report it first exposed (T21) is fixed; it stays unsupported for T28: the image decodes to 313 MB, past the 256 MB any stream may decode to, and the reader keeps the first 256 MB — reported, since T31, as its own limit (`filter.limit-exceeded`) |
